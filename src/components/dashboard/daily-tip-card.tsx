export function DailyTipCard() {
  return (
    <div className="relative p-5 rounded-xl overflow-hidden bg-[linear-gradient(135deg,_theme(colors.purple/0.1)_0%,_theme(colors.teal/0.06)_100%)] border border-purple/12">
      <div className="absolute top-[-20px] right-[-20px] w-[100px] h-[100px] bg-[radial-gradient(circle,_theme(colors.purple/0.15),transparent_70%)]" />
